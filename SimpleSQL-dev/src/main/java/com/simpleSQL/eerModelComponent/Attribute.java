 ...
 * This component appears as an oval with a gradient background and border, and
 * darkens when selected.
 */
public class Attribute extends ComponentBase {
	...
	/**
	 * Creates a copy of this Attribute with the same properties, location, and
	 * size.
	 *
