...
/**
 * Represents an Entity component in the EER model with custom rendering.
 * This component appears as a rounded rectangle with a gradient background and border,
...
public class Entity extends ComponentBase {
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(
                0, 0, backgroundTemp.brighter(),
                getWidth(), getHeight(), backgroundTemp);
        g2d.setPaint(gradient);
        g2d.fillRoundRect(BORDER_WIDTH / 2, BORDER_WIDTH / 2, getWidth() - BORDER_WIDTH, getHeight() - BORDER_WIDTH,
                CORNER_ARC, CORNER_ARC);

        // Draw the border of the rounded rectangle
        g2d.setStroke(new BasicStroke(BORDER_WIDTH));
        g2d.setColor(borderTemp);
        g2d.drawRoundRect(BORDER_WIDTH / 2, BORDER_WIDTH / 2, getWidth() - BORDER_WIDTH, getHeight() - BORDER_WIDTH,
                CORNER_ARC, CORNER_ARC);
